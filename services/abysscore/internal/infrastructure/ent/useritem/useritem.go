...
const (
	// Label holds the string label denoting the useritem type in the database.
	Label = "user_item"
	...
	EdgeItem = "item"
	// Table holds the table name of the useritem in the database.
	Table = "user_items"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "user_items"
...
// Columns holds all SQL columns for useritem fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldItemID,
