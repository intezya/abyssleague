...
func (sq *StatisticQuery) QueryUser() *UserQuery {
...
func (sq *StatisticQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (sq *StatisticQuery) WithUser(opts ...func(*UserQuery)) *StatisticQuery {
	query := (&UserClient{config: sq.config}).Query()
...
func (sq *StatisticQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Statistic, error) {
	...
	if query := sq.withUser; query != nil {
		if err := sq.loadUser(ctx, query, nodes, nil,
			func(n *Statistic, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (sq *StatisticQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Statistic, init func(*Statistic), assign func(*Statistic, *User)) error {
...
func (sq *StatisticQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(statistic.Table, statistic.Columns, sqlgraph.NewFieldSpec(statistic.FieldID, field.TypeInt))
	_spec.From = sq.sql
	...
	if fields := sq.ctx.Fields; len(fields) > 0 {
		...
		if sq.withUser != nil {
			_spec.Node.AddColumnOnce(statistic.FieldUserID)
		}
	}
